...
case 'allmenu':
case 'llmenu':
        ptod = "56922426846@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await cnf.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
◈​​┃
◈​​╰┄┅┄┅┄┅┄┅┄┅┄┅┄┅┄┅╯`
cnf.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./confumods.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtube.com/c/Alvnfut`}}})
break
case 'comandos':
stod = `${sender}`
 listMsg = {
...
"descriptionCount": "999999999",
  ...
  "businessOwnerJid": "56922426846@s.whatsapp.net",
  "contextInfo": {
